...
** The puts family
*/
void c_puts_at( unsigned int x, unsigned int y, const char *str ){
	unsigned int	ch;
...
char * cvtdec0( char *buf, unsigned int value ){
	int	quotient;
...
int cvtudec( char *buf, unsigned int value ) {
	char	*bp = buf;
